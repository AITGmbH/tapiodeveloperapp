 ...
 */
@NgModule({
    declarations: [ScenarioComponent, SelectMachineComponent, DateRangeComponent, LoadingComponent],
    ...
    exports: [ScenarioComponent, FontAwesomeModule, NgxDatatableModule, SelectMachineComponent, NgSelectModule, FormsModule, DateRangeComponent, LoadingComponent],
